      ...
      <div className="min-h-screen bg-ivory py-12 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-4">
            <div className="h-8 bg-sand/20 rounded w-3/4" /><div className="h-6 bg-sand/20 rounded w-1/2" /><div className="h-24 bg-sand/20 rounded" />
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            {product.category && <p className="text-gold font-semibold text-sm tracking-wider uppercase">{product.category.name}</p>}
